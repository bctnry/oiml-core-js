...
test('cmd2', typeof res_cmd2[0].A![3] === 'number', "fourth element of A part should be number.");
test('cmd2', typeof res_cmd2[0].A![4] === 'number', "fifth element of A part should be number.");
...
test('cmd2', res_cmd2[0].A![3] === 0x3, "fourth element of A part should be 0x3. ");
test('cmd2', res_cmd2[0].A![4] === 4.5, "fifth element of A part should be 4.5. ");
